...
{
    public partial class _38migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToppingsBase_Pizzas_PizzaModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToppingConnection", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToppingConnection_Pizzas_pizzaId",
                        column: x => x.pizzaId,
                        principalTable: "Pizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ToppingConnection_ToppingsBase_toppingId",
                        column: x => x.toppingId,
                        principalTable: "ToppingsBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToppingConnection_pizzaId",
                table: "ToppingConnection",
                column: "pizzaId");

            migrationBuilder.CreateIndex(
                name: "IX_ToppingConnection_toppingId",
                table: "ToppingConnection",
                column: "toppingId");

            migrationBuilder.CreateIndex(
                name: "IX_ToppingsBase_PizzaModelId",
                table: "ToppingsBase",
                column: "PizzaModelId");
        }
